...
The DA2 wireframes improve the original DA1 interface by adding clearer navigation, improved information hierarchy, workshop availability indicators, filtering and sorting, booking actions, and role-specific host functionality.

The six updated wireframes are included as submission screenshots:

1. [Login / Signup](design/wireframes/01-login-signup.png)
2. [Home / Discover](design/wireframes/02-home-discover.png)
3. [Search Results / Filter](design/wireframes/03-search-filter.png)
4. [Workshop Detail](design/wireframes/04-workshop-detail.png)
5. [Booking Confirmation](design/wireframes/05-booking-confirmation.png)
6. [Host Dashboard](design/wireframes/06-host-dashboard.png)

[Overall Wireframe View](design/wireframes/Overall%20SS.png)

### Design Principles Applied

**Abstraction:**  
Kalakriti separates user-facing functionality from implementation details. The frontend communicates with the backend through defined REST API interfaces, while database operations and business logic remain within the backend.

**Modularity:**  
The system is divided into focused modules such as authentication, user management, workshops, bookings, waitlist, reviews, and administration. This allows individual functionality to be developed and maintained independently.

**Cohesion:**  
Each module groups closely related responsibilities. For example, the Workshop module handles workshop-related operations, while the Booking module handles registration and seat availability.

**Low Coupling:**  
The frontend and backend communicate through REST APIs rather than directly depending on each other's internal implementation. This allows changes within one layer to be made with minimal impact on the other.

### Key Design Decisions

- **React + Vite** was selected for the frontend to provide a component-based interface for the learner and host workflows.
- **FastAPI** was selected for the backend to provide modular REST APIs for the platform's core operations.
- **PostgreSQL** was selected as the database for structured storage of users, workshops, sessions, bookings, waitlists, and reviews.
- **SQLAlchemy ORM** is used to separate application logic from direct database operations.
- **Docker and Docker Compose** are used to keep the application services consistently configured across development environments.
